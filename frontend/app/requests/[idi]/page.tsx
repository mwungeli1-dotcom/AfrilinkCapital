...
type SupplierRfq = { _id: string; status: string; currency?: string; unitPrice?: number; totalPrice?: number; minimumOrderQuantity?: string; leadTime?: string; shippingTerms?: string; notes?: string; supplierId?: { name: string; email: string; companyName?: string }; createdAt: string };
