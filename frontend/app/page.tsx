...
export default function Home() {
  ...
  const updateSaved = (productId: string, saved: boolean) => setSavedIds((current) => saved ? Array.from(new Set([...current, productId])) : current.filter((id) => id !== productId));
